...
public class ReviewControllerMvcTest {
    ...
    @Test
    public void shouldFindReviewsInModel() throws Exception {
    ...
    @Test
    public void shouldFindReviewThreeInModel() throws Exception {
        Long reviewThreeId = 3L;
        when(reviewRepo.findOne(reviewThreeId)).thenReturn(reviewThree);
        mockMvc.perform(get("/review?id=3"))
                .andExpect(model().attribute("reviewModel", reviewThree));
